...
/**
 * A child class shall subclass this Adapter and implement method getDataRow(int position, View
 * convertView, ViewGroup parent), which supplies a View present data in a ListRow.
 * 
 * This parent Adapter takes care of displaying ProgressBar in a row or indicating that it has
...
public abstract class GenericAdapter<T> extends BaseAdapter {
    ...
    /**
     * return the type of the row, the last row indicates the user that the ListView is loading more
     * data
     */
    @Override
